            ...
            <div className="col p-7 t-12 m-12">
              <div className="product__content-right">
                  ...
                  <div className="product__content-info">
                    ...
                    <div className="content-info--body">
                      <span className="content-info--text">
                        ...
                        {BEERAPP.truncate(desPro ? desPro : 'Bia Heineken Lager, hoặc đơn giản là Heineken là một loại bia lager nhạt với 5% cồn theo thể tích được công ty sản xuất bia Hà Lan Heineken N.V. sản xuất. Heineken nổi tiếng với chai màu xanh lá cây đặc trưng và ngôi sao đỏ', toggleReadMore)}
                      </span>
                      <span href="#" className="content-info--link" onClick={handleReadMore}>{!toggleReadMore ? 'Xem thêm' : 'Ẩn bơt'}</span>
                    </div>
                  </div>
                ...
                <div className="product__content-cart">
                  ...
                  <button onClick={() => { orderBeer(itemOrder, quantity) }} className="content-buy-text">Mua luôn</button>
                </div>
