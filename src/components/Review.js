...
function Review(props) {
    ...
    const reviewCustomer = getReview !== undefined ? getReview.map((review, indexReview) => {
        return (
            ...
            //         <p>{review.text}.</p>
            //         <p>
            //             <span className="float-right btn btn-outline-primary ml-2"> <i className="fa fa-reply" /> Reply</span>
            //             <span className="float-right btn text-white btn-danger"> <i className="fa fa-heart" /> Like</span>
            //         </p>
            //     </div>
            // </div>
            ...
            <div className="col p-12 m-12 t-12">
                ...
                <div className="product__review-pane product__review-pane-first">
                    <span href="#" className="product__review-link">
                ...
                <div className="review__pane-pagination--mobile show-on-mobile">
                    <span href="#" className="more__review-mobile">
                        Xem tất cả (2.9k)
            ...
            {/* <div className="card-inner">
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col-md-10">
                            <p><span href="https://maniruzzaman-akash.blogspot.com/p/contact.html"><strong>Maniruzzaman Akash</strong></span></p>
